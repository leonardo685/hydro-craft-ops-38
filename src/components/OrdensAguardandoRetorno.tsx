...
export function OrdensAguardandoRetorno({ isExpanded = true, onToggleExpand }: { isExpanded?: boolean; onToggleExpand?: () => void }) {
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => handleVisualizarOrdem(ordem.numero_ordem)}
                    >
